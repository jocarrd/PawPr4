<%-- 
    Document   : catalogo
    Created on : 18-mar-2021, 9:42:18
    Author     : jocarrd
--%>
      ...
      <div class="nucleo">
        ...
        <div class="contenido">
          ...
          <div class="resumResul redondeo">
              Encontrados <%arts.size();%> artículos.
          </div>
          <ul class="resultBusqueda">
              ...
              <div class="foto">
                  <a href="fichaArticulo.jsp?cart=+<%=a.getCodigo()%>">
                      <img src=<%= fotografia%> alt="Mie/088FO" longdesc="<%=a.getDescripcion()%>" width="80"></a>
              </div>
              <div class="datos">
