...
<!DOCTYPE html>
<html>
    <% String nombre=request.getParameter("cart") ;
    ...
    <div class="sombra">
      <div class="nucleo">
        <div id="migas">
          ...
          <a href="catalogo.jsp" title="Hojear catalogo">Hojear cat&aacute;logo</a>&nbsp; | &nbsp; 
          <%= nombre %>	<!-- &nbsp; | &nbsp; 
        ...
        <div class="contenido">
          ...
          <div class="datosDetalle">
            ...
            <div class="precio">
              <span>Precio <%= c.getPvp() %> &euro;</span>	
            </div>
